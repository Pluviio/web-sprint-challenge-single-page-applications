...
describe('Input Box', () => {
    it('lets user type their name into input', () => {
        cy.get('input[name=name]').should('have.value', '').type('Tyler').should('have.value', 'Tyler')
    })
})
...
describe('Special Instructions', () => {
    it('lets user type special instructions', () => {
        cy.get('input[name=special]').should('have.value', '').type('Did you bring my diet coke').should('have.value', 'Did you bring my diet coke')
    })
})
